...
var WechatPayment = function () {
    ...
    (0, _createClass3.default)(WechatPayment, [{
        ...
        value: function createUnifiedOrder(order, proxy) {
            var _this2 = this;
        ...
        key: 'queryOrder',
        value: function queryOrder(query, proxy) {
            var _this3 = this;
            ...
            return new _promise2.default(function (resolve, reject) {
                ...
                (0, _request2.default)(requestParam, function (err, res, body) {
                    _utils2.default.parseXML(body).then(function (result) {
                        resolve(result);
                    }).catch(function (err) {
                        reject(err);
        ...
        key: 'closeOrder',
        value: function closeOrder(order, proxy) {
            var _this4 = this;
        ...
        key: 'refund',
        value: function refund(order, proxy) {
            var _this5 = this;
        ...
        key: 'queryRefund',
        value: function queryRefund(order, proxy) {
            var _this6 = this;
